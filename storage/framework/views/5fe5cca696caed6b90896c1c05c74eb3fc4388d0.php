				...
				<div class="d-flex flex-column">
	          	...
	          	<div class="row mb-3">
	                <div class="expense_add">
	                    <a href="javascript:;" class="btn btn-outline-primary float-end m-1" data-bs-toggle="tooltip" onclick="rightModal('<?php echo e(route('accountant.fee_manager.open_modal', ['value' => 'single'])); ?>', '<?php echo e(get_phrase('Add  Single Invoice')); ?>')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Add Single Invoice')); ?></a>
	                    <a href="javascript:;" class="btn btn-outline-success float-end m-1" data-bs-toggle="tooltip" onclick="rightModal('<?php echo e(route('accountant.fee_manager.open_modal', ['value' => 'mass'])); ?>', '<?php echo e(get_phrase('Add  Mass Invoice')); ?>')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Add Mass Invoice')); ?></a>
	                </div>
	            </div>
	        </div>
	    </div>
...
<div class="row">
    <div class="col-12">
        <div class="eSection-wrap">
            <form method="GET" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('accountant.fee_manager.list')); ?>">
            	<div class="row">
				        ...
				        <div class="col-md-2 ">
		                    <div class="position-relative">
		                      ...
		                      <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
		                        ...
		                        <li>
		                            <a class="dropdown-item" id="download-button" href="<?php echo e(route('accountant.fee_manager.export', ['date_from' => $date_from, 'date_to' => $date_to, 'selected_class' => $sel_class, 'selected_status' => $sel_status])); ?>"><?php echo e(get_phrase('CSV')); ?></a>
		                        </li>
		                        <li>
            ...
            <div class="invoice_content" id="student_fee_manager">
	            <?php echo $__env->make('accountant.student_fee_manager.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	        </div>
		</div>
	</div>
</div>
...
<?php echo $__env->make('accountant.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mentor/public_html/resources/views/accountant/student_fee_manager/student_fee_manager.blade.php ENDPATH**/ ?>