                        ...
                        <div class="eForm-layouts">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('superadmin.system.update')); ?>">
                                ...
                                <div class="fpb-7">
                                    ...
                                    <input type="text" class="form-control eForm-control" value="<?php echo e(get_settings('system_email')); ?>" id="system_email" system_email = "name" required>
                                </div>
                                <div class="fpb-7">
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\Academy-mentor8\academy-mentor\resources\views/superadmin/settings/system_settings.blade.php ENDPATH**/ ?>