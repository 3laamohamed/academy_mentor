      ...
      <div class="col-12">
        ...
        >
          <div class="d-flex flex-column">
            <h4><?php echo e(get_phrase('school branches')); ?></h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
              <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('school branches')); ?></a></li>
            </ul>
          </div>
            ...
            <div class="table-responsive">
                <table class="table eTable">
                	...
                	<tbody>
                		...
                		<tr class="<?php if($branch->delete == 1): ?> text-danger <?php endif; ?>">
                			<td>
                				<?php echo e($key+1); ?>
    						...
    						<td class="text-center">
                                <div class="adminTable-action">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="<?php echo e(route('admin.branch.activationBranch',['id'=>$branch->id,'status'=>$branch->delete])); ?>"><?php if($branch->delete == 1): ?> Active <?php else: ?> Inactive <?php endif; ?></a>
                                        </li>
                                    </ul>
                                </div>
    						</td>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mentor/public_html/resources/views/admin/branches/branch_list.blade.php ENDPATH**/ ?>