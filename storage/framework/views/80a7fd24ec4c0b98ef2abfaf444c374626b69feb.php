    ...
    <table class="table eTable table-bordered">
        <thead>
            <tr>
                ...
                <th scope="col"><?php echo e(get_phrase('Mark')); ?></td>
                <th scope="col"><?php echo e(get_phrase('Grade point')); ?></td>
                <th scope="col"><?php echo e(get_phrase('Comment')); ?></td>
...
</script><?php /**PATH /home/mentor/public_html/resources/views/admin/marks/marks_list.blade.php ENDPATH**/ ?>