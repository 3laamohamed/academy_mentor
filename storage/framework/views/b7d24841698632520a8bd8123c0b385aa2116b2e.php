      ...
      <ul class="nav-links">
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/exam_category*') || request()->is('admin/offline_exam*') || request()->is('admin/marks') || request()->is('admin/grade') || request()->is('admin/promotion*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/exam_questions*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.exam_questions')); ?>"><span><?php echo e(get_phrase('Exam Questions')); ?></span></a>
                </li>
                <li>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/fee_manager*') || request()->is('admin/offline_payment/pending*')|| request()->is('admin/expense_category*') || request()->is('admin/expenses*') ? 'showMenu':''); ?>">
            ...
            <div class="iocn-link">
                <a class="<?php echo e((request()->is('admin/school_branch*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.school_branch')); ?>">
                    ...
                    <span class="link_name">
                        <?php echo e(get_phrase('school branches')); ?>
                ...
                <li class="nav-links-li <?php echo e(request()->is('admin/privacy_policy*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a class="<?php echo e((request()->is('admin/privacy_policy*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.policy')); ?>">
                    <div class="sidebar_icon">
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Isolation_Mode" data-name="Isolation Mode" width="48" height="48" viewBox="0 0 24 24"y style="enable-background:new 0 0 32 32;" version="1.1" xml:space="preserve"><style type="text/css">
	.st0{fill-rule:evenodd;clip-rule:evenodd;}
</style><path class="st0" d="M6.4,22.2v-0.4c0-0.8,0.2-1.6,0.5-2.3c0.3-0.7,0.8-1.4,1.3-2c0.6-0.6,1.2-1,2-1.3c0.7-0.3,1.5-0.5,2.3-0.5h4.6  c1,0,1.9-0.4,2.6-1.1c0.7-0.7,1.1-1.7,1.1-2.6s-0.4-1.9-1.1-2.6c-0.7-0.7-1.7-1.1-2.6-1.1h-6.4v3.7H6.4V4h11.1  c2.1,0,4.1,0.8,5.6,2.3c1.5,1.5,2.3,3.5,2.3,5.6c0,2.1-0.8,4.1-2.3,5.6c-1.5,1.5-3.5,2.3-5.6,2.3h-3.1l-1.9-0.1  C10.1,19.7,8,20.6,6.4,22.2z M10.8,22.4V28H6.4v0c0-2.4,1.5-4.5,3.6-5.4C10.3,22.5,10.5,22.4,10.8,22.4z"/></svg>                    </div>
                    <span class="link_name">
                        <?php echo e(get_phrase('privacy policy')); ?>
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/settings/school*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.login_code')); ?>">
                        <span>
                            <?php echo e(get_phrase('login code')); ?>
...
<?php /**PATH /home/fahinkbt/academy-mentor.com/resources/views/admin/navigation.blade.php ENDPATH**/ ?>