        ...
        <div class="form-row">
            ...
            <div class="fpb-7">
                ...
                <input type="number" min="0" class="form-control eForm-control" value="<?php echo e($package->price); ?>" id="price" name = "price" placeholder="Provide package price" required>
                        ...
                        <div class="fpb-7">
                <label for="branch" class="eForm-label"><?php echo e(get_phrase('Package max branch')); ?></label>
                <input type="number" min="0" class="form-control eForm-control" value="<?php echo e($package->branch); ?>" id="branch" name = "branch" placeholder="Provide package max brnach number" required>
            </div>
            <div class="fpb-7">
...
</script><?php /**PATH /home/mentor/public_html/resources/views/superadmin/package/edit_package.blade.php ENDPATH**/ ?>