      ...
      class="d-flex justify-content-between align-items-center flex-wrap gr-15"
        >
          ...
          <div class="export-btn-area">
            <a href="<?php echo e(route('admin.offline_admission.single', ['type' => 'single'])); ?>" class="btn btn-outline-primary float-end m-1"><?php echo e(get_phrase('Create Student')); ?></a>
          </div>
          <div class="export-btn-area">

            <a href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.delete_all_students', ['students' => $students->pluck('id')])); ?>', 'undefined');" class="btn btn-outline-danger float-end m-1" ><?php echo e(get_phrase('delete all Students')); ?></a>
          </div>
          <div class="export-btn-area">
            <a href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.block_all_students', ['students' => $students->pluck('id')])); ?>', 'undefined');" class="btn btn-outline-danger float-end m-1"><?php echo e(get_phrase('block all Student')); ?></a>
          </div>
          <div class="export-btn-area">
            <a href="<?php echo e(route('admin.unblock_all_students', ['students' => $students->pluck('id')])); ?>" class="btn btn-outline-success float-end m-1" ><?php echo e(get_phrase('unblock all Student')); ?></a>
          </div>
        </div>
      </div>
    </div>
      ...
      >
              ...
              <div class="filter-export-area d-flex align-items-center">
                ...
                <a href=<?php echo e(route('admin.student')); ?>>
                    ...
                    <?php echo e(get_phrase('clear Filter')); ?>
                        ...
                        <td>
                          <div class="adminTable-action">
                            ...
                            >
                              ...
                              <li>
                                <a class="dropdown-item" href='<?php echo e(route('admin.student_report', ['id' => $student->id])); ?>'><?php echo e(get_phrase('report')); ?></a>
                              </li>
                              <?php if($student->blocked==1): ?>
                              <li>
                                <a class="dropdown-item" href='<?php echo e(route('admin.student_unblock', ['id' => $student->id])); ?>'><?php echo e(get_phrase(' un block')); ?></a>
                              </li>
                              <?php else: ?>
                              <li>
                                <a class="dropdown-item" href='<?php echo e(route('admin.student_block', ['id' => $student->id])); ?>'><?php echo e(get_phrase('block')); ?></a>
                              </li>
                                  
                              <?php endif; ?>
                              <li>
                                <a class="dropdown-item" href='<?php echo e(route('admin.student_delete_device_id', ['id' => $student->id])); ?>'><?php echo e(get_phrase('delete device id')); ?></a>
                              </li>
                              <li>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mentor/public_html/resources/views/admin/student/student_list.blade.php ENDPATH**/ ?>