            ...
            >
                <div class="d-flex flex-column">
                    ...
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        ...
                        <li><a href="#"><?php echo e(get_phrase('Expense')); ?></a></li>
                    </ul>
                </div>
                <div class="export-btn-area">
                    <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('accountant.expenses.open_modal')); ?>', '<?php echo e(get_phrase('Create Expense')); ?>')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Add New Expense')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="eSection-wrap">
            <form method="GET" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('accountant.expense.list')); ?>">
                <div class="row">
            ...
            <div class="expense_content">
                <?php echo $__env->make('accountant.expenses.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('accountant.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mentor/public_html/resources/views/accountant/expenses/expense_manager.blade.php ENDPATH**/ ?>