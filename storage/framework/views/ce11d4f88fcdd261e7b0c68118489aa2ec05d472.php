    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/admin*') || request()->is('admin/teacher*') || request()->is('admin/accountant*') || request()->is('admin/librarian*') || request()->is('admin/parent*') || request()->is('admin/student') || request()->is('admin/permission*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a href="#">
                    ...
                    <span class="link_name"> المستخدمين </span>
                </a>
                <span class="arrow">
                  <svg
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/exam_category*') || request()->is('admin/offline_exam*') || request()->is('admin/marks') || request()->is('admin/grade') || request()->is('admin/promotion*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                <li>
                    <a class="<?php echo e((request()->is('admin/exam_category*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.exam_category')); ?>"><span> أقسام الإختبارات </span></a>
                </li>
                <li>
                    <a class="<?php echo e((request()->is('admin/offline_exam*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.offline_exam')); ?>"><span> الإختبارات </span></a>
                </li>
                <li>
                    <a class="<?php echo e((request()->is('admin/exam_questions*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.online_exam_questions')); ?>"><span> اسأله الإختبارات </span></a>
                </li>
                <li>
                    <a class="<?php echo e((request()->is('admin/marks')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.marks')); ?>"><span> الدرجات </span></a>
                </li>
                <li>
                    <a class="<?php echo e((request()->is('admin/grade')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.grade_list')); ?>"><span> التقدير </span></a>
                </li>
                <li>
                    <a class="<?php echo e((request()->is('admin/promotion*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.promotion')); ?>"><span> الترقيه والنقل </span></a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/attendance*') || request()->is('admin/class_list*') || request()->is('admin/routine*') || request()->is('admin/subject*') || request()->is('admin/syllabus*') || request()->is('admin/gradebook*') || request()->is('admin/class_room*') || request()->is('admin/department*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li><a class="<?php echo e((request()->is('admin/attendance_qr_codes*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.attendance_qr_codes')); ?>"><span>
                           رمز الغياب والحضور
                        </span></a></li>
                ...
                <li><a class="<?php echo e((request()->is('admin/lessons*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.lessons')); ?>"><span>
                           الدروس الأونلاين
                        </span></a></li>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/fee_manager*') || request()->is('admin/offline_payment/pending*')|| request()->is('admin/expense_category*') || request()->is('admin/expenses*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-links-li <?php echo e(request()->is('admin/school_branch*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a class="<?php echo e((request()->is('admin/school_branch*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.school_branch')); ?>">
                    <div class="sidebar_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Isolation_Mode" data-name="Isolation Mode" viewBox="0 0 24 24" width="48" height="48"><path d="M11,14H5a5.006,5.006,0,0,0-5,5v5H3V19a2,2,0,0,1,2-2h6a2,2,0,0,1,2,2v5h3V19A5.006,5.006,0,0,0,11,14Z"/><path d="M8,12A6,6,0,1,0,2,6,6.006,6.006,0,0,0,8,12ZM8,3A3,3,0,1,1,5,6,3,3,0,0,1,8,3Z"/><polygon points="21 10 21 7 18 7 18 10 15 10 15 13 18 13 18 16 21 16 21 13 24 13 24 10 21 10"/></svg>
                    </div>
                    <span class="link_name">
        ...
        <li class="nav-links-li <?php echo e(request()->is('hr/leave_list*') || request()->is('payroll/create/payslip*') || request()->is('attendence/list*') || request()->is('payroll/list*') || request()->is('user/roles*') || request()->is('user/list*')  ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="<?php echo e((request()->is('user/roles*')) ? 'active' : ''); ?>" href="<?php echo e(route('hr.user_role_index')); ?>">
                        <span>
                ...
                <li>
                    <a class="<?php echo e((request()->is('user/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('hr.userlist_index')); ?>">
                        <span>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/subscription') || request()->is('admin/events/list*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/events/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.events.list')); ?>"><span> المناسبات
                    </span></a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/settings/school*') || request()->is('admin/session_manager*') || request()->is('admin/settings/payment*') || request()->is('admin/live_class_settings*') || request()->is('admin/profile*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/settings/school*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.app_config')); ?>">
                        <span>
                            إعدادات التطبيق
                        </span>
                    </a>
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/settings/school*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.login_code')); ?>">
                        <span>
                           أكواد تسجيل الدخول
                        </span>
                    </a>
                ...
                <li>
              	...
              	<li><a class="<?php echo e((request()->is('admin/privacy_policy')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.policy')); ?>"><span>
                            سياسة الخصوصية
                        </span></a>
              	</li>
...
<?php /**PATH /home/mentor/public_html/resources/views/admin/navigation.blade.php ENDPATH**/ ?>