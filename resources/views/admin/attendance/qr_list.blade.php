      ...
      <div class="col-12">
        ...
        >
          ...
          {{-- <div class="export-btn-area"> --}}
            {{-- <a href="javascript:;" class="export_btn" onclick="rightModal('{{ route('admin.student_question.open_modal') }}', '{{ get_phrase('Add Exam question') }}')">{{ get_phrase('Add Exam question') }}</a> --}}
          {{-- </div> --}}
        </div>
      </div>
    </div>
                ...
                <table class="table eTable">
                	<thead>
                        <tr>
                            ...
                            <th scope="col" class="text-end">{{ get_phrase('qr') }}</th>
                        </tr>
                	</thead>
                	<tbody>
...
<script type="text/javascript">
  ...
  function Export() {
    ...
    var opt = {
      margin:       1,
      filename:     'qr_codes_list{{ date("y-m-d") }}.pdf',
