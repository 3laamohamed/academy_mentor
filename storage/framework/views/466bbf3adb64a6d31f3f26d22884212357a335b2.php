<div class="eoff-form">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.create.offline_exam')); ?>">
        ...
        <div class="form-row">
            ...
            <div class="fpb-7">
                <label for="is_exercise" class="eForm-label"><?php echo e(get_phrase('exam category')); ?><span class="required"></span></label>
                <select name="is_exercise" id="is_exercise" class="form-select eForm-select eChoice-multiple-with-remove" required>
                    <option value=""><?php echo e(get_phrase('Select exam category')); ?></option>
...
</script><?php /**PATH /home/fahinkbt/academy-mentor.com/resources/views/admin/examination/add_offline_exam.blade.php ENDPATH**/ ?>