	          ...
	          <div class="row">
	            ...
	            <div class="col-md-6">
	              <div class="dashboard_ShortListItem">
	                ...
	                >
	                  <div class="ds_item_details">
	                    <h4 class="total_no"><?php echo e(DB::table('users')->where('role_id', 4)->where('school_id', auth()->user()->school_id)->get()->count()); ?></h4>
	              ...
	              <div class="dashboard_ShortListItem">
	                ...
	                >
	                  <div class="ds_item_details">
	                  	...
	                  	<?php $teacher = DB::table('users')->where('role_id', 4)->where('school_id', auth()->user()->school_id)->get()->count() ?>
						<?php $accountant = DB::table('users')->where('role_id', 7)->where('school_id', auth()->user()->school_id)->get()->count() ?>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mentor/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>