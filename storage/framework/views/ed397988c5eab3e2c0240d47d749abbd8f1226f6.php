...
<head>
    <!-- New -->
    <title><?php echo e(get_phrase('Accountant').' | '.get_phrase('Ekattor')); ?></title>
    <!-- all the meta tags -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-links-li <?php echo e(request()->is('accountant/student_fee_manager*') || request()->is('accountant/offline_payment/pending*')|| request()->is('accountant/expense_category*') || request()->is('accountant/expenses*') ? 'showMenu':''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e((request()->is('accountant/student_fee_manager*')) ? 'active' : ''); ?>" href="<?php echo e(route('accountant.fee_manager.list')); ?>"><span>
                                <?php echo e(get_phrase('Student Fee Manager')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e((request()->is('accountant/offline_payment/pending*')) ? 'active' : ''); ?>" href="<?php echo e(route('accountant.offline_payment_pending')); ?>"><span>
                                <?php echo e(get_phrase('Offline Payment Request')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e((request()->is('accountant/expenses*')) ? 'active' : ''); ?>" href="<?php echo e(route('accountant.expense.list')); ?>"><span>
                                <?php echo e(get_phrase('Expense Manager')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e((request()->is('accountant/expense_category*')) ? 'active' : ''); ?>" href="<?php echo e(route('accountant.expense.category_list')); ?>"><span>
            ...
            <li class="nav-links-li <?php echo e(request()->is('accountant/noticeboard*') || request()->is('accountant/events/list*') ? 'showMenu':''); ?>">
              <div class="iocn-link">
                  <a href="#">
                      <div class="sidebar_icon">
              ...
              <ul class="sub-menu">
                  <li>
                    <a class="<?php echo e((request()->is('accountant/noticeboard*')) ? 'active' : ''); ?>" href="<?php echo e(route('accountant.noticeboard.list')); ?>">
                      <span><?php echo e(get_phrase('Noticeboard')); ?></span>
                    </a>
                  </li>
                  <li>
                      <a class="<?php echo e((request()->is('accountant/events/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('accountant.events.list')); ?>">
                  ...
                  <li class="user-profile">
                    <div class="btn-group">
                      ...
                      >
                        ...
                        <li>
                          <a class="dropdown-item" href="<?php echo e(route('accountant.password', ['edit'])); ?>">
                            <span>
...
</html><?php /**PATH /home/mentor/public_html/resources/views/accountant/navigation.blade.php ENDPATH**/ ?>