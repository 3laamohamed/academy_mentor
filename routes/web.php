...
Route::controller(AdminController::class)->middleware('admin','auth','CheckSubscription')->group(function () {
    ...
    //Lessons routes
    Route::get('admin/lessons','lessonsList')->name('admin.lessons');
    Route::get('admin/lessons_get_subjects', 'getSubject')->name('admin.lesson.get_subject');
    Route::get('admin/lessons_create', 'createLesson')->name('admin.lesson.open_modal');
    Route::post('admin/lessons', 'lessonCreate')->name('admin.create.lesson');
    Route::get('admin/lessons/edit_modal/{id}', 'editLesson')->name('lesson.open_edit_modal');
    Route::post('admin/lessons/{id}', 'lessonUpdate')->name('lesson.update');
    Route::get('admin/lessons/delete/{id}', 'lessonDelete')->name('admin.lesson.delete');

    //Videos routes
    Route::get('admin/videos/{id}','videosList')->name('admin.videos');
    Route::get('admin/videos_create/{id}', 'createVideos')->name('admin.video.open_modal');
    Route::post('admin/videos', 'videosCreate')->name('admin.create.videos');
    Route::get('admin/videos/edit_modal/{id}', 'editVideo')->name('video.open_edit_modal');
    Route::post('admin/videos/{id}', 'videoUpdate')->name('video.update');
    Route::get('admin/videos/delete/{id}', 'videoDelete')->name('admin.video.delete');

    //privacy policy routes
    Route::get('admin/privacy_policy','showPolicy')->name('admin.policy');
    Route::post('admin/privacy_policy_create', 'createPolicy')->name('admin.policy.create');
    ...
    Route::post('admin/student/edit/getClassRoom','getClassRoom')->name('admin.student.getClassRoom');
    Route::get('admin/student/report/{id}', 'studentReport')->name('admin.student_report');
    Route::get('admin/student/block/{id}', 'studentBlock')->name('admin.student_block');
    Route::get('admin/student/unblock/{id}', 'studentUnBlock')->name('admin.student_unblock');
    Route::get('admin/student/delete_device_id/{id}', 'studentDeleteDeviceId')->name('admin.student_delete_device_id');
    ...
    Route::get('admin/delete_all_students/{students}', 'deleteAllStudents')->name('admin.delete_all_students');
    Route::get('admin/unblock_all_students/{students}', 'unblockAllStudents')->name('admin.unblock_all_students');
    Route::get('admin/block_all_students/{students}', 'blockAllStudents')->name('admin.block_all_students');
    ...
    Route::get('admin/online_exam_questions', 'onlineExamsList')->name('admin.online_exam_questions');
    Route::get('admin/exam_questions/{id}', 'examQuestionList')->name('admin.exam_questions');
    Route::get('admin/exam_question/create/{id}', 'createExamQuestion')->name('admin.exam_question.open_modal');
    Route::post('admin/exam_question', 'examQuestionCreate')->name('admin.create.question');
    Route::get('admin/exam_question/{id}', 'editExamQuestion')->name('admin.edit.question');
    Route::post('admin/exam_question/{id}', 'examQuestionUpdate')->name('admin.question.update');
    Route::get('admin/exam_question/delete/{id}', 'examQuestionDelete')->name('admin.questions.delete');

    //login code routes
    Route::get('admin/login_code', 'loginCodeList')->name('admin.login_code');
    Route::get('admin/login_code/create', 'createLoginCode')->name('admin.login_code.open_modal');
    Route::post('admin/login_code', 'loginCodeCreate')->name('admin.create.login_codes');
    // Route::get('admin/login_code/{id}', 'useLoginCode')->name('admin.use.code');
    // Route::post('admin/login_code/{id}', 'loginCodeUse')->name('admin.code.use');

    //branch routes
    Route::get('admin/branches', 'branchList')->name('admin.school_branch');
    Route::get('admin/branches/create', 'createBranch')->name('admin.branches.open_modal');
    Route::post('admin/branch', 'branchCreate')->name('admin.create.branch');
    Route::get('admin/branch/{id}', 'editBranch')->name('admin.edit.branch');
    Route::post('admin/branch/{id}', 'branchUpdate')->name('admin.branch.edit');
    Route::get('admin/branch/activation/{id}/{status}', 'activationBranch')->name('admin.branch.activationBranch');
    ...
    // qr codes
    Route::get('admin/attendance_qr_codes', 'showQrGroups')->name('admin.attendance_qr_codes');
    Route::get('admin/qr_list/{id}', 'showQrList')->name('admin.qr_list');
    ...
    Route::get('admin/class_room/activation/{id}', 'classActivation')->name('admin.class_room.activation');
    ...
    //app Settings routes
    Route::get('admin/settings/app_config', 'appConfigList')->name('admin.settings.app_config');
    Route::get('admin/settings/app_config/enable_maintenance_mode', 'enableMaintenanceMode')->name('admin.settings.enable_maintenance_mode');
    Route::get('admin/settings/app_config/disable_maintenance_mode', 'disableMaintenanceMode')->name('admin.settings.disable_maintenance_mode');

    Route::get('admin/settings/app_config/enable_ios_maintenance_mode', 'enableIosMaintenanceMode')->name('admin.settings.enable_ios_maintenance_mode');
    Route::get('admin/settings/app_config/disable_ios_maintenance_mode', 'disableIosMaintenanceMode')->name('admin.settings.disable_ios_maintenance_mode');

    Route::post('admin/settings/app_config', 'appConfigUpdate')->name('admin.settings.update_app_config');
...
Route::get('privacy_policy/{id}', function($id){
        $policy=PrivacyPolicy::where('school_id',$id)->first();
        return view('admin.privacy_policy.show_policy',['policy'=>$policy]);
    })->name('admin.show.policy');
// privacy policy end
