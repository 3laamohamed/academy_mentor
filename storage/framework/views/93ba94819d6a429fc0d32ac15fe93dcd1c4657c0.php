        ...
        >
          <div class="d-flex flex-column">
            ...
            <ul class="d-flex align-items-center eBreadcrumb-2">
              ...
              <li><a href="#"><?php echo e(get_phrase('lessons')); ?></a></li>
            </ul>
          </div>
                        ...
                        <?php $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $class = Classes::get()->where('id', $row->class_id)->first(); ?>
                             <tr>
                                ...
                                <td> <a href="<?php echo e(route('admin.videos',$row->id)); ?>" >  <?php echo e($row->name); ?> </a> </td>
                                ...
                                <td class="text-start">
                                    <div class="adminTable-action">
                                        ...
                                        >
                                          <li>
                                            <a class="dropdown-item" href="<?php echo e(route('admin.videos',$row->id)); ?>" ><?php echo e(get_phrase('videos')); ?></a>
                                          </li>
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('lesson.open_edit_modal', ['id' => $row->id])); ?>', '<?php echo e(get_phrase('Edit lesson')); ?>')"><?php echo e(get_phrase('Edit')); ?></a>
                                          </li>
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.lesson.delete', ['id' => $row->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                                          </li>
                                        </ul>
                                    </div>
                                </td>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mentor/public_html/resources/views/admin/lesson/list.blade.php ENDPATH**/ ?>