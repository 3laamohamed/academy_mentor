	          ...
	          <div class="row">
	            ...
	            <div class="col-md-6">
	              <div class="dashboard_ShortListItem">
	                ...
	                >
	                  <div class="ds_item_details">
	                    <h4 class="total_no">{{ DB::table('users')->where('role_id', 4)->where('school_id', auth()->user()->school_id)->get()->count() }}</h4>
	              ...
	              <div class="dashboard_ShortListItem">
	                ...
	                >
	                  <div class="ds_item_details">
	                  	...
	                  	@php $teacher = DB::table('users')->where('role_id', 4)->where('school_id', auth()->user()->school_id)->get()->count() @endphp
						@php $accountant = DB::table('users')->where('role_id', 7)->where('school_id', auth()->user()->school_id)->get()->count() @endphp
