                ...
                <input type="text" class="form-control eForm-control" id="exam_name" name="exam_name" value="<?php echo e($exam->name); ?>" />
                        ...
                        <div>
                          ...
                          <option value="<?php echo e($group->id); ?>"
                            <?php if($exam->class_room_ids!=null&&$exam->class_room_ids!=''): ?>
...
<?php /**PATH /home/mentor/public_html/resources/views/admin/examination/edit_offline_exam.blade.php ENDPATH**/ ?>