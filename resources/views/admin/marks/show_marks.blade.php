...
<div class="row">
  <div class="col-12">
    <div class="eSection-wrap-2">
      ...
      >
              <form action="{{route('admin.marks.list',['id'=>$exam_id])}}">
                <div
                ...
                <span>
                  ...
                  @endif
                  @if($class_room_id != '')
                  <input type="hidden" name="class_room_id" id="class_room_id" value="{{ $class_room_id }}">
                  @endif
                </div>
              </form>
                    ...
                    <table class="table eTable" id='student_list'>
                        ...
                        <tbody>
                            @foreach($exams as $exam)
                                <tr>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td>{{ $exam_data->where('id',$exam->exam_id)->first()->name }}</td>
