...
<body>
	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li <?php echo e(request()->is('teacher/attendance*') || request()->is('teacher/routine') || request()->is('teacher/subject') || request()->is('teacher/gradebook') || request()->is('teacher/syllabus') ? 'showMenu':''); ?>">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
				...
				<ul class="sub-menu">
					<li><a class="<?php echo e((request()->is('teacher/attendance*')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.daily_attendance')); ?>"><span><?php echo e(get_phrase('Daily Attendance')); ?></span></a></li>
					<li><a class="<?php echo e((request()->is('teacher/routine')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.routine')); ?>"><span><?php echo e(get_phrase('Class Routine')); ?></span></a></li>
                    <li><a class="<?php echo e((request()->is('teacher/subject')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.subject_list')); ?>"><span><?php echo e(get_phrase('Subjects')); ?></span></a></li>
                    <li><a class="<?php echo e((request()->is('teacher/gradebook')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.gradebook')); ?>"><span><?php echo e(get_phrase('Gradebooks')); ?></span></a></li>
                    <li>
                        <a class="<?php echo e((request()->is('teacher/syllabus')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.list_of_syllabus')); ?>"><span><?php echo e(get_phrase('Syllabus')); ?></span></a>
                    </li>
				</ul>
			</li>

			<li class="nav-links-li <?php echo e(request()->is('teacher/marks') || request()->is('teacher/offline_exam') ? 'showMenu':''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e((request()->is('teacher/marks')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.marks')); ?>"><span><?php echo e(get_phrase('Marks')); ?></span></a>
                    </li>
                    <li>
                        <a class="<?php echo e((request()->is('teacher/offline_exam')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.offline_exam')); ?>"><span><?php echo e(get_phrase('Exam List')); ?></span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-links-li <?php echo e(request()->is('teacher/add_live_class*') ||request()->is('teacher/list_of_live_class*')   ? 'showMenu':''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                    	<a class="<?php echo e((request()->is('teacher/add_live_class*')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.add_live_class')); ?>">
                    		<span><?php echo e(get_phrase('Add new ')); ?></span>
                    		<!-- <span class="badge bg-success m-1" style=""><?php echo e(get_phrase('Addon')); ?></span> -->
                    	</a>
                    </li>
                    <li>
                    	<a class="<?php echo e((request()->is('teacher/list_of_live_class*')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.list_of_live_class')); ?>">
          ...
          <li class="nav-links-li <?php echo e(request()->is('hr/leave_list*') || request()->is('attendence/list*') || request()->is('payment/list*') ? 'showMenu':''); ?>">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                    	<a class="<?php echo e((request()->is('payment/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('hr.user_list_of_payrolls')); ?>">
            ...
            <li class="nav-links-li <?php echo e(request()->is('teacher/noticeboard*') || request()->is('teacher/events/list*') ? 'showMenu':''); ?>">
	            <div class="iocn-link">
	                <a href="#">
	                    <div class="sidebar_icon">
	            ...
	            <ul class="sub-menu">
	                <li>
	                	<a class="<?php echo e((request()->is('teacher/noticeboard*')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.noticeboard.list')); ?>">
	                		<span><?php echo e(get_phrase('Noticeboard')); ?></span>
	                	</a>
	                </li>
	                <li>
	                    <a class="<?php echo e((request()->is('teacher/events/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.events.list')); ?>">
                  ...
                  <li class="user-profile">
                    <div class="btn-group">
                      ...
                      >
                        ...
                        <li>
                          <a class="dropdown-item" href="<?php echo e(route('teacher.password', ['edit'])); ?>">
                            <span>
...
<?php /**PATH C:\pc files\projects\academy_mentor\resources\views/teacher/navigation.blade.php ENDPATH**/ ?>